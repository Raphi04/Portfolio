...
<body>
    ...
    <section id="mainContent">
        <section id="project">
            ...
            <a href="recommandation.pdf" id="voirPlus"><section>
                <p>VOIR PLUS</p>
            </section></a>
        </section>
        <section id="projectInfo">
            <h3>Rédaction</h3>
            <h2>Recommandation de produit : Razer Kraken Pro V2</h2>
            <p id="madeBy">Réalisé le : 02/12/2022</p>
            <p id="projectDescription">Nous devions réaliser un article de recommandation d'un produit en anglais.<br><br>Pour cela il fallait nous inspirer d'article déjà existant et essayer des les imiter.<br><br>Pour le choix des polices d'écriture et des couleurs, j'ai réutilisé celle que nous avons défini en groupe lors d'un projet nommé "Digit'All"</p>
